		...
		try {
			...
			case INTEGER:
				...
				State = 274; _localctx._INTEGER = Match(INTEGER);
				 try{ _localctx.retValue =  new ValueExpression(int.Parse((_localctx._INTEGER!=null?_localctx._INTEGER.Text:null)));} catch { _localctx.retValue =  new ValueExpression(long.Parse((_localctx._INTEGER!=null?_localctx._INTEGER.Text:null))); } 
				}
				break;
			case FLOAT:
				EnterOuterAlt(_localctx, 2);
