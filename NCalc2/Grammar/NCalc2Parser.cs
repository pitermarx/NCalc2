...
namespace NCalc2.Grammar
{
    ...
    public partial class NCalc2Parser : Parser
    {
        ...
        public partial class NcalcContext : ParserRuleContext
        {
            ...
            {
                return GetToken(NCalc2Parser.Eof, 0);
            }
        ...
        public partial class ValueContext : ParserRuleContext
        {
            ...
            {
                return GetToken(NCalc2Parser.INTEGER, 0);
            }

            public ITerminalNode DATETIME()
            {
                return GetToken(NCalc2Parser.DATETIME, 0);
            }

            public ITerminalNode FALSE()
            {
                return GetToken(NCalc2Parser.FALSE, 0);
            }

            public ITerminalNode TRUE()
            {
                return GetToken(NCalc2Parser.TRUE, 0);
            }

            public ITerminalNode STRING()
            {
                return GetToken(NCalc2Parser.STRING, 0);
            }

            public ITerminalNode FLOAT()
            {
                return GetToken(NCalc2Parser.FLOAT, 0);
            }
                ...
                switch (_input.La(1))
                {
                    case INTEGER:
                        EnterOuterAlt(_localctx, 1);
                        {
                            ...
                            try { _localctx.retValue = new ValueExpression(int.Parse((_localctx._INTEGER != null ? _localctx._INTEGER.Text : null))); }
                            catch { _localctx.retValue = new ValueExpression(long.Parse((_localctx._INTEGER != null ? _localctx._INTEGER.Text : null))); }
                        }
                        break;
        ...
        public partial class IdContext : ParserRuleContext
        {
            ...
            {
                return GetToken(NCalc2Parser.VAR, 0);
            }

            public ITerminalNode NAME()
            {
                return GetToken(NCalc2Parser.NAME, 0);
            }
